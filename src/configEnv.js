...
export const MONGODB_URI = process.env.MONGODB_URI //|| "mongodb://localhost/test" //indica, si no se encuentra la conexion MONGO_URI crea una conexion local y crea una BD nombre TEST
